...
class Account {
    ...
    public String toString() {
        ...
        // Parse the balance to double and format it
        double balanceValue = Double.parseDouble(balance.substring(0, balance.length() - 1)); // Remove the dollar sign
        String formattedBalance = String.format("%.2f$", balanceValue);

        sb.append("Balance: ").append(formattedBalance).append("\n");
...
class Bank {
    ...
    public boolean makeTransaction(Transaction t) {
        //postoet smetkite
        if (findId(t.getFromId()) == -1 || findId(t.getToId()) == -1) {
            return false;
        }
        //dali imat dovolno sredstva
    ...
    public boolean equals(Object o) {
        ...
        Bank bank = (Bank) o;
        return Double.compare(totalProvision, bank.totalProvision) == 0 && Double.compare(totalTransfers, bank.totalTransfers) == 0 && Objects.equals(name, bank.name) && Arrays.equals(accounts, bank.accounts);
    }

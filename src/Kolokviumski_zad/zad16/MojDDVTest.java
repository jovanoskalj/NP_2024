 package Kolokviumski_zad.zad16;
...
class MojDDV {
    ...
    public void printStatistics(PrintStream out) {
        ...
        DoubleSummaryStatistics doubleSummaryStatistics =
                users.stream().mapToDouble(User::totalTax).summaryStatistics();

        printWriter.printf("min:\t%.3f%n", doubleSummaryStatistics.getMin());
        printWriter.printf("max:\t%.3f%n", doubleSummaryStatistics.getMax());
        printWriter.printf("sum:\t%.3f%n", doubleSummaryStatistics.getSum());
        printWriter.printf("count:\t%d%n", doubleSummaryStatistics.getCount());
        printWriter.printf("avg:\t%.3f%n", doubleSummaryStatistics.getAverage());
        printWriter.flush();
    }
}
